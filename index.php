    ...
    <body>
		...
		<div id="header">
			<p class="logintext">
				...
				{
					echo "<a href='index.php?content=logout'>Log out</a> | <a href='index.php?content=profile&user_id=".$_SESSION['user_id']."'>" . $_SESSION['username'] . "&nbsp;<img src=\"avatar/" . $_SESSION['username'] . ".png\" height=\"30px\" width=\"auto\" /></a>&nbsp;";
				}else
